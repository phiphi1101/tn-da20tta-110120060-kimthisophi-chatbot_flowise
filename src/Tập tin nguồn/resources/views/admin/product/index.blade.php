                            ...
                            <tbody>
                                @foreach ($products as $productItem)
                                    <tr>
                                        ...
                                        <td>
                                            @foreach($productItem->inventorys as $item)
                                            <p>{{ $item->color }} ({{ $item->size }}): {{ $item->quantity }} cái</p>
                                            @endforeach
                                        </td>
                                        ...
                                        <td>
                                            <a href="{{ $productItem->product_link }}" target="_blank">{{ $productItem->product_link }}</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
