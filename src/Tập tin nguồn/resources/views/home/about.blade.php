            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 mb-3 mb-lg-0">
                        <h2 class="title">Mani's Stylish Fashion Online</h2><!-- End .title -->
                        <p>Cửa hàng chuyên cung cấp quần áo nam, nữ theo phông cách hiện đại. Đi theo xu hướng thời trang hiện nay. Sản phẩm có phông cách riêng mang lại cho khách hàng sự thoải mái nhất. Hình thức mua bán online </p>
                    </div><!-- End .col-lg-6 -->

                    <div class="col-lg-6">
                        <h2 class="title">Mani's Stylish Fashion Offline</h2><!-- End .title -->
                        <p>Cửa hàng chuyên cung cấp quần áo nam, nữ theo phông cách hiện đại. Đi theo xu hướng thời trang hiện nay. Sản phẩm có phông cách riêng mang lại cho khách hàng sự thoải mái nhất. hình thức mua bán Offline
                        </p>
                    </div><!-- End .col-lg-6 -->
                </div><!-- End .row -->
